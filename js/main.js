require([], function (){
    ...
    var loadMobile = function(){
        require(['/untitled/js/mobile.js'], function(mobile){
            mobile.init();
            isMobileInit = true;
        });
    }
    var isPCInit = false;
    var loadPC = function(){
        require(['/untitled/js/pc.js'], function(pc){
            pc.init();
            isPCInit = true;
        });
    }
    ...
    if(yiliaConfig.fancybox === true){
        require(['/untitled/fancybox/jquery.fancybox.js'], function(pc){
            var isFancy = $(".isFancy");
            if(isFancy.length != 0){
    ...
    if(yiliaConfig.animate === true){
        ...
        require(['/untitled/js/jquery.lazyload.js'], function(){
            //avatar
